...
public class MathSubClass extends MathMainClass {
    ...
    static MathSubClass p;
//overrinding

    public void Playmin(String nama) {
//        Instansiasi
...
//
        ...
        while (true) {
            ...
            while (score > 200 && score <= 300) {
                ...
                if (score > 300) {
                    System.out.println("[Selamat " + nama + ", Anda telah menyelesaikan soal pengurangan dengan baik. Terimakasih sudah bermain :)]");
                    break;
                }
            }
            break;
