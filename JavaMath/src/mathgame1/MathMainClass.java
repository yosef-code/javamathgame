package mathgame1;
import java.util.*;
import static mathgame1.MathSubClass.p;
...
//                    User Interface
                    ...
                    if (angka == hasilPenjumlahan) {
                        score = score + 4;
                        System.out.println("[Hallo " + nama + "][Score: " + score + "][Lives: " + lives + "][level: " + lvl + "]");
                        System.out.println("___________________________________");
                    } else {
                        score = score - 1;
                        lives = lives - 1;
                        System.out.println("[Hallo " + nama + "][Score: " + score + "][Lives: " + lives + "][leve1"
                                + "l: " + lvl + "]");
                        System.out.println("___________________________________");
                    }
                } else {
                    System.out.println("[Maaf " + nama + " kamu kehabisan nyawa, silakan mulai ulang game ini]");
                    break;
                }
            }
            if (score == -1) {
                System.out.println("[Maaf " + nama + " skor kamu tidak valid]");
                break;
            }
...
//                    UserInterface
                    ...
                    if (angka == hasilPenjumlahan) {
                        score = score + 4;
                        System.out.println("[Hallo " + nama + "][Score: " + score + "][Lives: " + lives + "][level: " + lvl2 + "]");
                        System.out.println("___________________________________");
                    } else {
                        score = score - 1;
                        lives = lives - 1;
...
//                    User Interface
                    ...
                    if (angka == hasilPenjumlahan) {
                        score = score + 4;
                        System.out.println("[Hallo " + nama + "][Score: " + score + "][Lives: " + lives + "][level: " + lvl3 + "]");
                        System.out.println("___________________________________");
                    } else {
                        score = score - 1;
                        lives = lives - 1;
                ...
                if (score > 300) {
                    System.out.println("[Selamat " + nama + ", Anda telah menyelesaikan soal penjumlahan dengan baik. Silakan dicoba soal pengurangan ya]");
                    break;
                }
            }
            break;
...
//    Overloading method
    ...
    public void Playplus(int s, int l, String nama) {
//        Instansiasi
        MathNumberFormat mf1 = new MathNumberFormat();
        MathNumberFormat mf2 = new MathNumberFormat();
        MathMainClass data = new MathMainClass();
...
//                    
 ...
 public void Playmin(int s, int l, String nama) {
MathSubClass.p = new MathSubClass();
        p.Playmin();
}}
